...
class APIKeyManager:
    ...
    def rotate_key(self, key_id: int) -> tuple[Optional[APIKey], Optional[str]]:
        """
    ...
    def revoke_key(self, key_id: int, reason: Optional[str] = None) -> bool:
        """
    ...
    def get_key_stats(self, key_id: int) -> Optional[dict]:
