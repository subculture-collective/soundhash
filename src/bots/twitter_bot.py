...
class TwitterBot:
    ...
    def listen_for_mentions(self):
        ...
        try:
            # Get recent mentions
            mentions = self.api.get_mentions(max_results=50, tweet_fields=['author_id', 'created_at', 'conversation_id'])
    ...
    def find_matches(self, video_url: str) -> List[dict]:
        ...
        try:
            ...
            for match in matches:
                ...
                if video_id not in unique_matches or match['confidence'] > unique_matches[video_id]['confidence']:
