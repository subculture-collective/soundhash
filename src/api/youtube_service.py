...
class YouTubeAPIService:
    ...
    def get_channel_videos(
        ...
        try:
            ...
            if max_results is None:
                ...
                self.logger.info(
                    f"Fetching up to {max_results} videos from channel {channel_id}"
                )
            ...
            while retrieved_count < max_results:
                ...
                batch_size = (
                    min(50, max_results - retrieved_count)
            ...
            self.logger.error(
                f"HTTP error getting videos for channel {channel_id}: {e}"
            )
            return []
        except Exception as e:
    ...
    def _parse_duration(self, duration_str: str) -> Optional[int]:
        ...
        try:
            ...
            # Remove PT prefix
            duration_str = (
                duration_str[2:] if duration_str.startswith("PT") else duration_str
            )
