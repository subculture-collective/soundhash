...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column('is_lifetime_commission', sa.Boolean(), nullable=False, server_default=sa.false()),
        ...
        sa.Column('total_commission_earned', sa.Integer(), nullable=False, server_default='0'),
        sa.Column('total_commission_paid', sa.Integer(), nullable=False, server_default='0'),
