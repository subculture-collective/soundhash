...
class TestDatabaseModels:
    ...
    def test_audio_fingerprint_model_creation(self, in_memory_db):
        ...
        # Query back
        retrieved = (
            in_memory_db.query(AudioFingerprint).filter_by(fingerprint_hash="abc123def456").first()
        )
    ...
    def test_match_result_model_creation(self, in_memory_db):
        ...
        # Query back
        retrieved = in_memory_db.query(MatchResult).filter_by(query_fingerprint_id=fp1.id).first()
    ...
    def test_processing_job_model_creation(self, in_memory_db):
        ...
        # Query back
        retrieved = in_memory_db.query(ProcessingJob).filter_by(job_type="video_process").first()
    ...
    def test_channel_video_relationship(self, in_memory_db):
        ...
        retrieved_channel = in_memory_db.query(Channel).filter_by(channel_id="UC123456789").first()
    ...
    def test_video_fingerprints_relationship(self, in_memory_db):
        ...
        retrieved_video = in_memory_db.query(Video).filter_by(video_id="dQw4w9WgXcQ").first()
